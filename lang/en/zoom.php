...
$string['auth_user'] = 'Enable meeting authentication';
$string['auth_user_help'] = 'The participants need to authenticate prior to joining the meetings.';
$string['auth_option'] = 'Authentication Profile ID';
$string['auth_option_help'] = 'Specify authentication profile ID';
$string['auth_domain'] = 'Authentication Domain';
$string['auth_domain_help'] = 'This option, allows you to specify the rule so that Zoom users, whose email address contains a certain domain, can join the meeting or webinar. You can either add multiple domains, using a comma in between and/or use a wildcard for listing domains Eg : *.zoom.in';
