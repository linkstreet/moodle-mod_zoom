...
$string['join_auth'] = 'Enable Authenticated User';
$string['join_auth_help'] = 'If you enable this, only the authenticated users can join the session. The participants should login to their zoom account and join the session.';
$string['auth_user'] = 'Authenticated User';
